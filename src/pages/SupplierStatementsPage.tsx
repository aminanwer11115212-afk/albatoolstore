 ...
 * الرصيد موجب يعني **ما علينا له** — وهو ما يعنيه المستخدم حين يسأل «كم
 * للمورد عندي؟». ويُحسب من الأوامر غير المستلَمة لا من `suppliers.balance`،
 * لأن العمود المخزَّن يجمع المستلَم أيضاً فلا يعرف قاعدة الاستبعاد. فيُعرض:
 *
 *   له   → أحمر  (دَينٌ علينا)
        ...
        <div className="flex items-start justify-between gap-3 flex-wrap">
          <div>
            ...
            <p className="text-xs text-muted-foreground mt-1">
              اختر مورّداً لعرض كشف حسابه التفصيلي — الأرصدة محسوبة من الأوامر
              <b>غير المستلَمة</b> وحدها، فالمستلَم دخلت بضاعته ولا يُسجَّل هنا.
            </p>
          </div>
