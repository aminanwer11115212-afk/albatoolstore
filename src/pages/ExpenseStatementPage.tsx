    ...
    <article className="content">
      ...
      <div className="printable-statement legacy-card card-block">
        ...
        <div data-section="filters" data-section-label="الفلاتر" className="legacy-form-horizontal" style={{ marginBottom: "1rem" }}>
          ...
          <div className="legacy-form-row"><label className="legacy-form-label">طريقة الدفع</label><div className="legacy-form-control-wrap"><select className="legacy-control" value={method} onChange={(e) => setMethod(e.target.value)}><option value="">الكل</option><option value="cash">نقدي</option><option value="bank">بنك</option><option value="card">بطاقة</option><option value="check">شيك</option></select></div></div>
