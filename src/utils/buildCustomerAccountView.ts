...
/**
 * نصّ سطر الإيراد — **المبلغ وحده بإشارته**.
 *
 * جُرِّب إلحاق الحساب ورقم العملية به ليتمايز شحنان بنفس المبلغ، فصار السطر
 * أربعة أسطر على الهاتف: «تم شحن +3,000 — اولاد جابر — بنك الخرطوم — رقم
 * العملية 6080». وجدولُ الكشف عمودُه ضيّق، فطال البيان حتى ابتلع الصفّ.
 *
 * والكشف موضعٌ للأرقام لا للتفاصيل: ما يعني العميل هنا كم دخل وكم بقي، وهو
