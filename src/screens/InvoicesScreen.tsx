...
/**
 * شاشة إدارة الفواتير — المنطق المشترك بين قائمة الفواتير الآجلة وقائمة
 * فواتير الكاش. فوقها صفحتان رفيعتان: `InvoicesPage` و`CashInvoicesPage`.
 */
export default function InvoicesScreen({ posOnly = false }: { posOnly?: boolean } = {}) {
