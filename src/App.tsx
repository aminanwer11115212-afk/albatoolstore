...
const TransportersPage = () => <SimpleCrudPage title="الناقلين" hook={useTransporters} fields={[{ key: "name", label: "الاسم" }, { key: "phone", label: "الهاتف" }, { key: "vehicle_type", label: "نوع المركبة" }, { key: "vehicle_number", label: "رقم المركبة" }, { key: "notes", label: "ملاحظات" }]} />;
      ...
      <BrowserRouter>
        ...
        <AppLayout>
          <Routes>
            ...
            <Route path="/invoices/cash" element={lazyEl(<InvoiceCreatePage />, "مبيعات كاش")} />
