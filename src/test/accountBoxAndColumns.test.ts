 ...
 *     38px، وبإخفاء «تفاصيل الترحيل» صار 496px — قفزةُ 458px.
...
describe("عمودا الكمية والسعر", () => {
   ...
   */
  /* وانضمّ إليهما عمودُ الإجمالي: كان ثقلُه سطرياً 700 فيخرج أخفَّ منهما. */
  it("وقاعدتُهما ثِقلٌ لا مقاسٌ — الجدولُ كلُّه متساوٍ", () => {
    const rule = /\.col-qty,\s*\.col-price,\s*\.col-total\s*\{([^}]*)\}/.exec(html);
