...
/**
 * ## ومجموعُ القطع يعدّ الطردَ قطعةً حين لا قطعَ فيه
 *
 * «فمثلاً كتبت 5 كرتونة كبيرة، تظهر إجمالي القطع 5».
 *
 * والصورةُ المطبوعة التي أرسلها فيها ستّةُ أسطر، أحدُها «1 كرتونة كبيرة» بلا
 * عدد قطع — ومجموعُها 99. فتُعاد بحروفها هنا.
 */
describe("مجموعُ القطع كما في الورقة المطبوعة", () => {
  ...
  it("وأسطرُ الورقة المطبوعة كما هي ⇒ 99", () => {
    expect(shown([
