...
--
--  يجمع كل الهجرات المعلّقة التي لم تُطبَّق على القاعدة المنشورة. كلها
--  `CREATE OR REPLACE` فآمنة التكرار: شغّلها مرّة أو عشراً، النتيجة واحدة.
--
--  بعد التشغيل تختفي رسالة:
--    Could not find the function public.delete_customer_credit_entry ...
--  ويصير شحن الرصيد لا يُوزَّع تلقائياً، وحذف الفاتورة يمحو دفعتها.
-- ============================================================================
